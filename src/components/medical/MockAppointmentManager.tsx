...
export function MockAppointmentManager() {
  const { user } = useAuth()
  ...
  async function createAppointment() {
    ...
    try {
      ...
      // 입력 검증
      if (!newAppointment.hospitalName || !newAppointment.department || 
          !newAppointment.date || !newAppointment.time || !newAppointment.doctorName) {
